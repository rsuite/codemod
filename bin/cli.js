...
// rsuite-codemod optional-name-of-transform optional/path/to/src [...options]
...
function checkGitStatus(force) {
  ...
  if (!clean) {
    if (force) {
      ...
      console.log("Thank you for using rsuite-codemods!");
      console.log(
        chalk.yellow(
...
const TRANSFORMER_INQUIRER_CHOICES = [
  {
    name: "icons-standalone: Replace deprecated Icon component with @rsuite/icons package",
    value: "icons-standalone",
  },
  {
    name: "alert-to-toaster: Replace deprecated Alert api with toaster api",
...
function run() {
  const cli = meow(
    {
      description: "Codemods for upgrading React Suite",
      help: `
    Usage
      $ npx rsuite-codemod <transform> <path> <...options>

        transform    One of the choices from https://github.com/rsuite/codemod
