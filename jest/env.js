...
const read = (fileName) =>
  fs.readFileSync(p.join(__dirname, global.baseDir, "test", fileName), "utf8");

global.test = (transformName, testFileName, options, fakeOptions) => {
  console.warn(
    "rsuite-codemod test() is deprecated. Please use jscodeshift testUtils " +
